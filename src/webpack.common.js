...
const PROJECT_NAME = 'docker-nginx-php7'
const PROJECT_USER = 'blunt1337'
const PROJECT_REPO = 'docker-alpine-nginx-php7'
const PROJECT_DESCRIPTION = 'nginx + php7 docker image'
const PROJECT_COLOR = '#3F51B5'
